...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    Iterable<Product> findByPriceAndNameAndDescriptionAndCreateDate(double price, String name, String description, LocalDateTime createDate);
    ...
    Iterable<Product> findByCategoryAndNameAndDescriptionAndCreateDate(String category, String name, String description, LocalDateTime createDate);
}
